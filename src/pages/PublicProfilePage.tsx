...
import { User, Mail, Calendar, Trophy, Star, Zap, Shield, ArrowLeft } from 'lucide-react';
...
const PublicProfilePage: React.FC = () => {
  ...
  if (!profile) {
    return (
      <div className="min-h-screen flex flex-col items-center justify-center p-6 text-center">
        ...
        <h2 className="text-2xl font-black text-gray-900 mb-2">ব্যবহারকারী পাওয়া যায়নি</h2>
        <p className="text-gray-500 mb-8">দুঃখিত, এই প্রোফাইলটি খুঁজে পাওয়া সম্ভব হয়নি।</p>
  ...
  return (
    <div className="space-y-10 pb-10">
      ...
      <button 
        onClick={() => navigate(-1)}
        className="flex items-center gap-2 text-gray-500 font-black uppercase tracking-widest text-[10px] hover:text-indigo-600 transition-colors"
      >
        <ArrowLeft size={14} />
        ফিরে যান
      </button>
